...
class ReturnInspectionController extends Controller
{
    ...
    public function store(Request $request, Reservation $reservation)
    {
        ...
        $validated = $request->validate([
            ...
            'condition_items.*.condition_status' => ['required', 'string', Rule::enum(ConditionStatus::class)],
            'condition_items.*.severity' => ['nullable', 'string', Rule::enum(Severity::class)],
        ...
        try {
            $inspection = DB::transaction(function () use ($request, $reservation, $validated) {
            ...
            return back()
                ->withErrors(['inspection' => 'The return inspection could not be saved. Please review the details and try again.'])
                ->withInput();
        }
