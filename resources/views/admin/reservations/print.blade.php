...
<body>
    <div class="container">
                        ...
                        <tbody>
                            @foreach($reservation->payments as $p)
                                <tr>
                                    ...
                                    <td style="padding: 6px 4px; border-bottom: 1px solid #F3F4F6;">{{ $currency }} {{ number_format((float)$p->amount, 0) }}</td>
        ...
        <div class="section">
            ...
            <div class="section-body">
                <div class="row"><span class="label">Daily Rate</span><span class="value">{{ $currency }} {{ number_format((float)$reservation->daily_rate, 0) }}</span></div>
                <div class="row"><span class="label">Subtotal</span><span class="value">{{ $currency }} {{ number_format((float)$reservation->subtotal, 0) }}</span></div>
                <div class="row"><span class="label">Tax</span><span class="value">{{ $currency }} {{ number_format((float)$reservation->tax_amount, 0) }}</span></div>
                <div class="row"><span class="label">Discount</span><span class="value">-{{ $currency }} {{ number_format((float)$reservation->discount_amount, 0) }}</span></div>
                <div class="row totals"><span class="label">Total</span><span class="value">{{ $currency }} {{ number_format((float)$reservation->total_amount, 0) }}</span></div>
            </div>
        </div>
    </div>
</body>
