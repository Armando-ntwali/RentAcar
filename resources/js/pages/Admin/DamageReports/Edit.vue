...
import { show as damageReportsShow, update as damageReportsUpdate } from '@/routes/admin/damage-reports';
...
function submit() {
  form.put(damageReportsUpdate(props.damageReport.id).url);
}
  ...
  <AdminLayout>
    <main class="flex-1 p-8 space-y-6">
      <div class="flex items-center justify-between gap-4">
        ...
        <Link :href="damageReportsShow(damageReport.id).url">
