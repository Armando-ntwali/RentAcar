...
import { store as damageReportStore } from '@/routes/admin/damageReports';
import { inspectionComparison } from '@/routes/admin/reservations';
...
function submit() {
  form.post(damageReportStore(props.reservation.id).url);
}
  ...
  <AdminLayout>
    <main class="flex-1 p-8 space-y-6">
      <div class="flex items-center justify-between gap-4">
        ...
        <Link :href="inspectionComparison(reservation.id).url">
