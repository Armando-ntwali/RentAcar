  ...
  <AdminLayout>
    <main class="flex-1 p-8 space-y-6">
        ...
        <div class="rounded-md border bg-white p-4">
          ...
          <div class="space-y-2 text-sm">
            ...
            <div>
              ...
              <div class="font-medium">UGX {{ Number(dispute.damageReport?.estimated_cost || 0).toLocaleString('en-US', { maximumFractionDigits: 0 }) }}</div>
            </div>
            <div>
      ...
      <div v-if="!showRespond && !showResolve && !showReject" class="flex gap-2 flex-wrap">
        ...
        <Link :href="route('admin.damage-reports.show', dispute.damageReport?.id)">
