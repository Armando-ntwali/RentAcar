        ...
        <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            ...
            >
                ...
                >
                    <div class="relative">
                        <div
                            class="h-8 w-8 animate-spin rounded-full border-4 border-blue-200 border-t-blue-900"
                        ></div>
                    </div>
                ...
                <div class="flex flex-col gap-8 lg:flex-row">
                            ...
                            >
                                <span class="flex items-center">
                                    ...
                                    <span
                                        ...
                                        class="ml-2 rounded-full bg-blue-900 px-2 py-1 text-xs text-white"
                                        >{{
                                            Object.values({
                                ...
                                <form @submit="handleSearch" class="space-y-3">
                                    <div class="relative">
                                        <input
                                            ...
                                            class="w-full rounded-xl border border-gray-300 py-2 pr-4 pl-12 text-gray-900 placeholder-gray-500 transition-all duration-200 focus:border-blue-900 focus:ring-4 focus:ring-blue-100"
                                    ...
                                    <button
                                        type="submit"
                                        class="w-full rounded-xl bg-gradient-to-r from-blue-900 to-blue-800 px-6 py-2 font-semibold text-white shadow-lg transition-all duration-200 hover:from-blue-800 hover:to-blue-700 hover:shadow-xl focus:ring-4 focus:ring-blue-200"
                                    >
                                        Search Fleet
                                    </button>
                                </form>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            class="w-full rounded-xl border border-gray-300 px-4 py-2 text-gray-900 transition-all duration-200 focus:border-blue-900 focus:ring-4 focus:ring-blue-100"
                                        >
                                        ...
                                        <div class="grid grid-cols-2 gap-3">
                                            <div class="relative">
                                                ...
                                                <input
                                                    ...
                                                    type="number"
                                                    placeholder="Min"
                                                    class="w-full rounded-xl border border-gray-300 py-2 pr-4 pl-12 text-gray-900 transition-all duration-200 focus:border-blue-900 focus:ring-4 focus:ring-blue-100"
                                                />
                                            </div>
                                            <div class="relative">
                                                <span
                    ...
                    <div class="lg:w-3/4">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span
                                        class="rounded-full bg-blue-100 px-3 py-1 font-medium text-blue-900"
                                    >
                        ...
                        >
                            ...
                            <button
                                @click="clearFilters"
                                class="rounded-xl bg-gradient-to-r from-blue-900 to-blue-800 px-8 py-3 font-semibold text-white shadow-lg transition-all duration-200 hover:from-blue-800 hover:to-blue-700"
                            >
                                View All Vehicles
                            </button>
                        </div>
                            ...
                            >
                                ...
                                >
                                    <button
                                        ...
                                        class="rounded-xl bg-gradient-to-r from-blue-900 to-blue-800 px-6 py-3 font-semibold text-white shadow-lg transition-all duration-200 hover:from-blue-800 hover:to-blue-700"
                                    >
                                        Previous
                                    </button>
                                    <span
