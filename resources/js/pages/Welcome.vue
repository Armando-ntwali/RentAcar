                ...
                <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="grid items-center gap-16 lg:grid-cols-2">
                        ...
                        <div class="space-y-10">
                            <div class="space-y-6">
                                ...
                                >
                                    Drive Your
                                    <span
                                        class="bg-gradient-to-r from-blue-900 to-blue-800 bg-clip-text text-transparent"
                                    >
                                        Dreams
                                    </span>
                                </h1>
                            ...
                            <div class="flex flex-col gap-4 sm:flex-row">
                                <a
                                    :href="fleet.url()"
                                    class="group cursor-pointer inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-blue-900 to-blue-800  text-md px-5 py-2 font-semibold text-white shadow-xl transition-all duration-200 hover:scale-105 hover:from-blue-800 hover:to-blue-700 hover:shadow-2xl"
                                >
                                    <svg
                                ...
                                <a
                                    :href="about.url()"
                                    class="inline-flex cursor-pointer items-center justify-center rounded-xl border-2 border-gray-300 bg-white text-md px-5 py-2 font-semibold text-gray-700 transition-all duration-200 hover:border-blue-900 hover:text-blue-900 hover:shadow-lg"
                                >
                                    Learn More
                                </a>
                            </div>
                            ...
                            >
                                <div class="text-center">
                                    <div
                                        class="bg-gradient-to-r from-blue-900 to-blue-800 bg-clip-text text-4xl font-bold text-transparent"
                                    >
                                        1000+
                                    </div>
                                    <div
                        ...
                        <div class="flex justify-center lg:justify-end">
                            <div class="relative">
                                <div
                                    class="absolute -inset-4 rounded-3xl bg-gradient-to-r from-blue-900/20 to-blue-800/20 blur-2xl"
                                ></div>
                                <img
            ...
            <section id="fleet" class="bg-white py-24">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="mb-20 text-center">
                        <div
                            class="mb-6 inline-flex items-center rounded-full bg-blue-50 px-4 py-2 text-sm font-semibold text-blue-900 ring-1 ring-blue-200"
                        >
                    ...
                    <div class="mt-16 text-center">
                        <a
                            :href="fleet.url()"
                            class="inline-flex cursor-pointer items-center rounded-xl bg-gradient-to-r from-blue-900 to-blue-800 px-8 py-4 font-semibold text-white shadow-xl transition-all duration-200 hover:scale-105 hover:from-blue-800 hover:to-blue-700 hover:shadow-2xl"
                        >
                            <svg
                                class="mr-2 h-5 w-5"
                                fill="none"
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid gap-12 md:grid-cols-3">
                        <div class="group text-center">
                            <div
                                class="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-900 to-blue-800 shadow-xl transition-transform duration-200 group-hover:scale-110"
                            >
                                <svg
