            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <nav class="flex h-16 items-center justify-between">
                    ...
                    <div class="hidden items-center space-x-8 md:flex">
                        <Link
                            :href="home()"
                            :class="{ 'text-blue-900': $page.url === home().url, 'text-gray-700': $page.url !== home().url }"
                            class="font-medium transition-colors hover:text-blue-900"
                        >
                            Home
                        </Link>
                        <Link
                            :href="fleet()"
                            :class="{ 'text-blue-900': $page.url.startsWith('/fleet'), 'text-gray-700': !$page.url.startsWith('/fleet') }"
                            class="font-medium transition-colors hover:text-blue-900"
                        >
                            Fleet
                        </Link>
                        <Link
                            :href="about()"
                            :class="{ 'text-blue-900': $page.url === '/about', 'text-gray-700': $page.url !== '/about' }"
                            class="font-medium transition-colors hover:text-blue-900"
                        >
                            About
                        </Link>
                        <Link
                            :href="contact()"
                            :class="{ 'text-blue-900': $page.url === '/contact', 'text-gray-700': $page.url !== '/contact' }"
                            class="font-medium transition-colors hover:text-blue-900"
                        >
                            Contact
                        </Link>
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <template v-else>
                            ...
                            <Link
                                :href="register()"
                                class="inline-flex items-center rounded-xl bg-gradient-to-r from-blue-900 to-blue-800 px-6 py-2.5 text-sm font-semibold text-white shadow-lg transition-all duration-200 hover:scale-105 hover:from-blue-800 hover:to-blue-700 hover:shadow-xl"
                            >
                                Get Started
                            </Link>
                        </template>
                ...
                <div class="grid gap-12 md:grid-cols-4">
                    <div class="space-y-6">
                        ...
                        <p class="leading-relaxed text-gray-400">
                            Transparent car rental management with comprehensive vehicle condition assessment, inspection evidence documentation, and evidence-based dispute resolution.
                        </p>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-3 text-gray-400">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <span>support@rentacar.test</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <svg
                                    class="h-5 w-5 text-blue-400"
